    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-96 bg-gray-800">
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1568393691622-c7ba131d63b4?q=80&w=1631&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')"
          }}
        />
