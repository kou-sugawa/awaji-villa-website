...
export default function PricingPage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative h-96 bg-gradient-to-r from-green-900 to-blue-700">
        <div 
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">小型犬</h3>
              <p className="text-sm text-gray-600 mb-3">体重10kg未満</p>
              <div className="text-2xl font-bold text-pink-600 mb-4">
                ¥2,000
                <span className="text-sm text-gray-600">/泊</span>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center border-2 border-blue-300">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Heart className="w-8 h-8 text-blue-600" />
              </div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">中・大型犬</h3>
              <p className="text-sm text-gray-600 mb-3">体重10kg以上</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">猫</h3>
              <p className="text-sm text-gray-600 mb-3">室内飼育のみ</p>
          ...
          <div className="mt-8 bg-white p-6 rounded-lg shadow-lg">
            <h4 className="text-lg font-semibold text-gray-900 mb-3">ペット同伴に関する注意事項</h4>
            <ul className="text-gray-600 space-y-2">
              <li>• 最大3頭まで同伴可能です</li>
              <li>• 予防接種証明書の提示が必要です</li>
              <li>• 室内でのマーキング・粗相は清掃費別途請求となります</li>
              <li>• 備品の破損・汚損は実費請求となります</li>
            </ul>
          </div>
        </div>
      </section>
